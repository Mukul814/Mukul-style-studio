        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              reach their full potential through innovative solutions and strategic planning.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Founded in 2020, Business Pro has grown from a small consultancy to
                a full-service business solutions provider. Our journey has been
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                ...
                quality in our services and deliverables.
              </p>
            </div>
            <div className="text-center">
